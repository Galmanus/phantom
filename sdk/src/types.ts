...
export interface ShieldedNote {
  ...
  spent: boolean;
  // OBSTACLE 1: Note status for concurrency handling
  // 'pending' = submitted to chain, not yet confirmed
  // 'confirmed' = in block, nullifier not spent  
  // 'spent' = nullifier spent on-chain
